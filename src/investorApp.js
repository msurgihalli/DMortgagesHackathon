...
class App extends Component {
    ...
    constructor(props) {
        super(props);
        var input = JSON.parse(props.result);
        console.log(input);
        this.state = {
            aionweb3: null,
            aiwa: false,
            ...
            value: " ",
            propertyOwner : JSON.parse(props.result).propertyOwner,
            propertyValue : JSON.parse(props.result).propertyValue,
            propertyLocation : JSON.parse(props.result).propertyLocation,
            propertyBuyerKyc : JSON.parse(props.result).propertyBuyerKyc,
            propertyBuyerCreditScore : JSON.parse(props.result).propertyBuyerCreditScore,
            propertyBuyerIncome : JSON.parse(props.result).propertyBuyerIncome,
            propertyLoanRequested : JSON.parse(props.result).propertyLoanRequested,
            mortgageMonthlyPayment : JSON.parse(props.result).mortgageMonthlyPayment,
